...
Влез: Прво се дава број N на кориснички имиња и лозинки кои ќе бидат внесени во системот.  
	  ...
	  Потоа се даваат редови со кориснички имиња и лозинки на корисници кои се обидувата да се најават
	  (Пр. ana banana) За означување на крај на обидите во редицата се дава зборот KRAJ

Излез: За секој од влезовите кои се обид за најава се печати Nenajaven се додека не дoбиеме 
	   Najaven или додека имаме обиди за најава.
...
public class Lozinki {
	...
	public static void main(String[] args) throws IOException{
		...
		CBHT<String,String> map = new CBHT<String,String>(2*N);
		for(int i=0; i<N; i++) {
		...
		while(!s.equals("KRAJ")) {
			String [] pom = s.split(" ");
			if(map.search(pom[0]) != null) {
				String value = map.search(pom[0]).getElement().value;
				if(pom[1].equals(value)) {
					sb.append("Najaven"+" ");
					break;
				}else {
					sb.append("Nenajaven"+" ");
